...
typedef struct Response__Socket Response__Socket;
typedef struct Response__Connect Response__Connect;
typedef struct Response__Close Response__Close;
typedef struct Response__Recvfrom Response__Recvfrom;
typedef struct Response__Sendto Response__Sendto;
typedef struct Response__Poll Response__Poll;
typedef struct Response__Select Response__Select;
typedef struct Response__Getpeername Response__Getpeername;
typedef struct Response__Getsockname Response__Getsockname;
typedef struct Response__Getsockopt Response__Getsockopt;
typedef struct Response__Setsockopt Response__Setsockopt;
typedef struct Response__Fcntl Response__Fcntl;
typedef struct Response__Atstart Response__Atstart;
...
typedef enum {
  ...
  RESPONSE__RETURNING_ATSTART_ACTION = 16
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RESPONSE__RETURNING__CASE)
...
#define RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&response__descriptor) \
    , RESPONSE__RET_CODE__OK, RESPONSE__RETURNING__NOT_SET, {0} }
