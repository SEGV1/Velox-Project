...
#ifndef VELOXD_TCP_TCPHDR_H
#define VELOXD_TCP_TCPHDR_H
...
// Cannot use enum class, because we need to perform > < comparisons on these values
enum TcpState
{
    TCP_STATE__CLOSED,
    TCP_STATE__LISTEN,
