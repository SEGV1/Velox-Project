...
#ifndef VELOXD_LOGGING_H
#define VELOXD_LOGGING_H
...
////////////////////////////////////////////////////////////////////////////////
// Define Macro `VELOXD_LOG(sev)` for logging
//
...
// VELOXD_LOG(info) << "a example log";
// VELOXD_LOG(debug) << "a example log";
// == EXAMPLE END

// clang-format off

#define VELOXD_LOG(sev)                                                     \
